const fs = require('fs');
let code = fs.readFileSync('src/components/JsonBackupRestoreModal.tsx', 'utf8');
...
if (code.includes('handleImport')) {
  ...
  fs.writeFileSync('src/components/JsonBackupRestoreModal.tsx', code);
  console.log("Rewritten JsonBackupRestoreModal");
}
