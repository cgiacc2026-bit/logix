...
export interface JournalEntry {
  ...
  sourceModule?: 'MANUAL' | 'SALES_INVOICE' | 'PURCHASE_INVOICE' | 'SALES_RETURN' | 'PURCHASE_RETURN' | 'RECEIPT' | 'PAYMENT' | 'RECEIPT_VOUCHER' | 'PAYMENT_VOUCHER' | 'INVENTORY' | 'OPENING' | 'INVOICE_REVERSAL';
  sourceId?: string;
}
