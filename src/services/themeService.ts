...
export const ERP_THEMES: Record<ThemeMode, ThemePaletteDefinition> = {
  light: {
    id: 'light',
    labelAr: 'المؤسسي العصري الفاتح (Clean Enterprise Light)',
    labelEn: 'Modern Clean Enterprise Light',
    descriptionAr: 'واجهة عصرية أنيقة باللون الأبيض والرمادي الفاتح Slate-50 مع لمسات الزمرد التنفيذية لإراحة العين وتحسين تجربة المستخدم',
    swatchHex: '#059669',
    primaryColor: '#059669',
    primaryHover: '#047857',
    ...
    textMain: '#0F172A',
    textMuted: '#64748B',
    activeItemGradient: 'from-emerald-50 to-emerald-100',
    activeItemGradientStyle: 'linear-gradient(to left, #ECFDF5, #F0FDF4)',
    activeItemBorder: 'border-emerald-600',
    activeItemBorderColor: 'rgba(5, 150, 105, 0.8)',
    lightBg: '#F8FAFC',
    lightBorder: '#E2E8F0',
    badgeBg: '#ECFDF5',
    badgeText: '#065F46',
