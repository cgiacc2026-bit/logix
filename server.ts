  ...
  app.post('/api/journals', (req, res) => {
    try {
      ...
      const newJournal: JournalEntry = {
        ...
        reference: reference || '',
        description: description || 'قيد يومية محاسبي',
  ...
  app.post('/api/invoices', (req, res) => {
    try {
      ...
      const invoice: Invoice = {
        ...
        salesPerson: req.body.salesPerson || req.body.salesRepName || '',
        salesRepId: req.body.salesRepId || req.body.rep_id || req.body.sales_rep_id || undefined,
        rep_id: req.body.rep_id || req.body.salesRepId || req.body.sales_rep_id || undefined,
        sales_rep_id: req.body.salesRepId || req.body.rep_id || req.body.sales_rep_id || undefined,
        salesRepName: req.body.salesRepName || req.body.salesPerson || undefined,
        warehouseId: req.body.warehouseId || req.body.warehouse_id || 'wh-main-01',
        warehouse_id: req.body.warehouse_id || req.body.warehouseId || 'wh-main-01',
        warehouseName: req.body.warehouseName || 'المستودع الرئيسي (الشويخ)',
